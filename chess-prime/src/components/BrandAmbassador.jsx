...
import React from 'react';
import { Award, ChevronRight, Star, Users, Trophy } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            <div className="relative group">
              ...
              <div className="relative bg-[#1E1A16] rounded-2xl overflow-hidden border border-yellow-500/20">
                <div className="aspect-[4/5] flex items-center justify-center bg-[#2A241E]">
                  <span className="text-8xl text-yellow-500/30">♞</span>
                </div>

                <div className="absolute top-4 left-4 bg-black/60 border border-yellow-500/30 rounded-full px-4 py-2">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-[#1E1A16] rounded-xl p-4 border border-yellow-500/20 text-center">
                ...
                <div className="text-xs text-gray-400">Training Quality</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-3xl md:text-4xl font-bold mb-2">
                Professional <span className="text-yellow-500">Chess Coaching</span>
              </h3>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p className="text-lg">
                Our academy provides a structured and result-oriented chess training program 
                designed for beginners, intermediate players, and advanced learners. We focus 
                on building strong fundamentals, strategic thinking, and competitive skills.
              </p>

              <p className="text-lg">
                With expert guidance, interactive sessions, and practical gameplay analysis, 
                students develop confidence, concentration, and decision-making abilities that 
            ...
            <div className="space-y-4">
              {[
                "From beginner to advanced level mastery",
            ...
            <div className="bg-gradient-to-r from-yellow-500/10 to-transparent border-l-4 border-yellow-500 p-6 rounded-r-xl">
              <p className="font-medium italic">
                "We focus on developing not just players, but strategic thinkers."
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              ...
              <button className="border border-yellow-500/30 hover:border-yellow-500 px-6 py-3 rounded-lg font-semibold transition flex items-center gap-2">
                <Award size={18} />
                View Courses
              </button>
            </div>
