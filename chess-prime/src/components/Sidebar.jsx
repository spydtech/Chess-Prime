...
// Quick Match Modal with Time Selection
function QuickMatchModal({ isOpen, onClose, onMatchFound }) {
  const [step, setStep] = useState('selection'); // 'selection' or 'searching'
  ...
  const timeControls = [
    { id: '1+0', name: '1+0', label: 'Bullet', rating: '1200-1400' },
    { id: '2+1', name: '2+1', label: 'Bullet', rating: '1300-1500' },
    { id: '3+0', name: '3+0', label: 'Blitz', rating: '1400-1600' },
    { id: '3+2', name: '3+2', label: 'Blitz', rating: '1400-1600' },
    { id: '5+0', name: '5+0', label: 'Blitz', rating: '1500-1700' },
    { id: '5+3', name: '5+3', label: 'Blitz', rating: '1500-1700' },
    { id: '10+0', name: '10+0', label: 'Rapid', rating: '1600-1800' },
    { id: '10+5', name: '10+5', label: 'Rapid', rating: '1600-1800' },
    { id: '15+10', name: '15+10', label: 'Rapid', rating: '1700-1900' },
    { id: '30+0', name: '30+0', label: 'Classical', rating: '1800-2000' }
  ];
  ...
  const handleStartSearch = () => {
    ...
    // Simulate finding an opponent after 3-5 seconds
    setTimeout(() => {
      setSearching(false);
      setTimeElapsed(0);
      const matchData = {
      ...
      <div className="bg-[#1a0f0a] rounded-lg border border-white/10 w-96 p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-white text-lg font-semibold">
            {step === 'selection' ? 'Quick Match' : 'Finding Opponent'}
          </h2>
        ...
        {step === 'selection' ? (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-amber-500 hover:bg-amber-600 text-black font-semibold py-3 rounded-lg transition flex items-center justify-center gap-2 mt-2"
            >
              <Search size={18} />
